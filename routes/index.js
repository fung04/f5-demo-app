...
router.get('/', function(req, res, next) {
    ...
    res.render('index', { title: 'Demo App (default)',
        server_ip: server_ip,
...
router.get('/ws', function(req, res, next) {
    ...
    res.render('ws', { title: 'Demo App - Websockets (default)',
        server_ip: server_ip,
        server_port: server_port,
        client_ip: client_ip,
        client_port: client_port,
...
router.get('/contact', function(req, res, next) {
    ...
    res.render('contact', { title: 'Demo App - Contact (default)',
        server_ip: server_ip,
        server_port: server_port,
        client_ip: client_ip,
        client_port: client_port,
...
router.get('/login', function(req, res, next) {
    ...
    res.render('login', { title: 'Demo App - Login (default)',
        server_ip: server_ip,
        server_port: server_port,
        client_ip: client_ip,
        client_port: client_port,
...
router.get('/uri([A-Za-z0-9_]+)', function(req, res, next) {
    ...
    res.render('index', { title: 'Demo App - Dynamic (default)',
        server_ip: server_ip,
        server_port: server_port,
        client_ip: client_ip,
        client_port: client_port,
...
router.get('/static', function(req, res, next) {
    ...
    res.render('index', { title: 'Demo App - Static (default)',
        server_ip: server_ip,
        server_port: server_port,
        client_ip: client_ip,
        client_port: client_port,
